...
export const NavBar: React.FC<BoxProps> = ({backgroundtype, ...props }: BoxProps) => {
    ...
    if (backgroundtype) {
        if (backgroundtype === "clear") backdropfilter="none", bordercolor = "none", borderwidth="0", fontcolor="white", fontcolor2="black", backgroundimage="linear-gradient(white, white)", backgroundcolor="none", shadowvalue="none";
        if (backgroundtype === "blur") backdropfilter="blur(5px)", bordercolor = "white", borderwidth="1px", fontcolor="black", fontcolor2="white", backgroundimage="linear-gradient(to right, darkblue, black)", backgroundcolor="rgba(255, 255, 255, 0.5)", shadowvalue="2xl";
    }
    ...
    return (
        <Box shadow={shadowvalue} backgroundColor={backgroundcolor} backdropFilter={backdropfilter} borderColor={bordercolor} borderWidth={borderwidth} borderRadius='12px' display='flex' alignItems='baseline' h='50px' {...props}>
            ...
            <Box style={{position:"relative", marginLeft:"auto", marginRight:"auto", width:"450px", marginTop:"10px", height:"30px"}}>
                <Box as='button' style={style0} borderRadius='md' color={fontcolor} px={2} h={8}>
                    <Box style={style2}><SiHackthebox/>&nbsp;DASHBOARD</Box></Box>
                <Box as='button' style={style1} borderRadius='md' color={fontcolor} px={2} h={8}>
